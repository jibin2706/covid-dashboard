  ...
  return (
    <ResponsiveContainer>
      <AreaChart data={data} width={400} height={300}>
        ...
        <Area stackId="1" type="linear" dataKey="deaths" stroke="#dc3545" fill="#dc3545" name="Deaths" />
        <Area stackId="1" type="monotone" dataKey="recovered" stroke="#82ca9d" fill="#82ca9d" name="Recovered" />
        <Area
          stackId="1"
          type="monotone"
          dataKey="confirmed"
